import React from 'react'
 ...
 class ItemsTable extends React.Component {
  ...
  Each row has an onChange property attached. When the checkbox is clicked, the item for that row is passed as an argument to toggleDone to change the state of done.
